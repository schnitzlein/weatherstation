...
class Example(object): 
    ...
    def run(self):
       ...
       while not quit:
                ...
                currWind = "{}mph ".format(windSpeed) + weather_com_result['current_conditions']['wind']['text']  
                ...
                currTempFeeling = "Feel" + weather_com_result['current_conditions']['feels_like'] + u'\N{DEGREE SIGN}' + "C"
