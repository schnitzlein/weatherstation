...
# update interval
updateRate = 600 # seconds, for server call
...
class Example(object):
    ...
    def run(self):
       ...
       while True:
                ...
                # TODO: check if weather_com_result is True so the dictionary exist with new data; else keep old result
                #new_data = {}
                
                # retrieve data from weather.com
                weather_com_result = pywapi.get_weather_from_weather_com(weatherDotComLocationCode)
                #if not(weather_com_result):
                #  print "no connection"
                ...
                currWind = "{} kmh ".format(windSpeed) + weather_com_result['current_conditions']['wind']['text']
                ...
                currTempFeeling = weather_com_result['current_conditions']['feels_like'] + "C"
                ...
                for i in range(start, 5):
                    ...
                    forecastWinds[i] = weather_com_result['forecasts'][i]['day']['wind']['speed']  + "Km/h"
 ...
 #TODO: 0 while betweenTime < updateRate
 #TODO: 1. wait 10 secounds Here; betweenTime+=10
 #TODO: 2. clear screen
 #TODO: 3. update screen with forecast text
 #TODO: 4. wait 10 seocunds Here; betweenTime+=10
 #TODO: 5. clear screen
 #TODO: 6. update screen with dayInformation text and Logo
 #TODO: 7. leave inner while after betweenTime > updateRate; receive new Information from network
