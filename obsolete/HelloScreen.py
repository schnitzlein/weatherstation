...
installPathImgBig = "/home/user/Develop/python/weatherstation/img/big/"
installPathImgSmall = "/home/user/Develop/python/weatherstation/img/small/"
...
class PyLcd :
    ...
    def __init__(self):
        ...
        try:
            pygame.display.init()
            print("foobar: ",pygame.display.get_init())
        ...
        get_width = pygame.display.Info().current_w
        get_height = pygame.display.Info().current_h
        print("current width: ", get_width)
        print("current height: ", get_height)
...
class PygameWeather(object):
    ...
    def callServer( self, mydict ):
       ...
       if self.weather_com_result.has_key('error') or self.weather_com_result == {}:
           ...
           self.weather_com_result = old_values
           return old_values
       else:
    ...
    def run(self):
       ...
       while not quit:
                ...
                print("Reaching here without error")
                # special screen
                self.showScreen3()
                ...
                print("Reaching screen 1.")
                # 1. screen, dayInformation
                self.showScreen1()

                print("Reaching screen 2.")
                # 2. screen, forecast
                self.showScreen2()
                print("Done screen 2.")
